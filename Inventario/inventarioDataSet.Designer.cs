...
namespace Inventario {
    ...
    public partial class inventarioDataSet : global::System.Data.DataSet {
        ...
        public partial class clienteDataTable : global::System.Data.TypedTableBase<clienteRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute ()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute ("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            protected clienteDataTable (global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : base (info, context) {
                this.InitVars ();
            }
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute ()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute ("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public clienteRow AddclienteRow (string nombre_cliente, string email, string telefono, bool estado) {
...
namespace Inventario.inventarioDataSetTableAdapters {
    ...
    public partial class clienteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter () {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[cliente] WHERE (([codigo_cliente] = @Original_codigo_cliente) AND ((@IsNull_nombre_cliente = 1 AND [nombre_cliente] IS NULL) OR ([nombre_cliente] = @Original_nombre_cliente)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_telefono = 1 AND [telefono] IS NULL) OR ([telefono] = @Original_telefono)) AND ((@IsNull_estado = 1 AND [estado] IS NULL) OR ([estado] = @Original_estado)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[cliente] ([nombre_cliente], [email], [telefono], [estado]) VAL" +
                "UES (@nombre_cliente, @email, @telefono, @estado);\r\nSELECT codigo_cliente, nombr" +
                "e_cliente, email, telefono, estado FROM cliente WHERE (codigo_cliente = SCOPE_ID" +
                "ENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[cliente] SET [nombre_cliente] = @nombre_cliente, [email] = @email, [telefono] = @telefono, [estado] = @estado WHERE (([codigo_cliente] = @Original_codigo_cliente) AND ((@IsNull_nombre_cliente = 1 AND [nombre_cliente] IS NULL) OR ([nombre_cliente] = @Original_nombre_cliente)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_telefono = 1 AND [telefono] IS NULL) OR ([telefono] = @Original_telefono)) AND ((@IsNull_estado = 1 AND [estado] IS NULL) OR ([estado] = @Original_estado)));
SELECT codigo_cliente, nombre_cliente, email, telefono, estado FROM cliente WHERE (codigo_cliente = @codigo_cliente)";
        ...
        private void InitCommandCollection () {
            ...
            this._commandCollection[0].CommandText = "SELECT codigo_cliente, nombre_cliente, email, telefono, estado FROM dbo.cliente";
        ...
        public virtual int Delete (int Original_codigo_cliente, string Original_nombre_cliente, string Original_email, string Original_telefono, global::System.Nullable<bool> Original_estado) {
        ...
        public virtual int Insert (string nombre_cliente, string email, string telefono, global::System.Nullable<bool> estado) {
        ...
        public virtual int Update (string nombre_cliente, string email, string telefono, global::System.Nullable<bool> estado, int Original_codigo_cliente, string Original_nombre_cliente, string Original_email, string Original_telefono, global::System.Nullable<bool> Original_estado, int codigo_cliente) {
            if ((nombre_cliente == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute ("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute (global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update (string nombre_cliente, string email, string telefono, global::System.Nullable<bool> estado, int Original_codigo_cliente, string Original_nombre_cliente, string Original_email, string Original_telefono, global::System.Nullable<bool> Original_estado) {
            return this.Update (nombre_cliente, email, telefono, estado, Original_codigo_cliente, Original_nombre_cliente, Original_email, Original_telefono, Original_estado, Original_codigo_cliente);
        }
    }
